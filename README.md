## <img src="/image/OMZ_favicon.png" width=16px; hegith=16px;/> FAVOREAT 소개 (SSAFY 8기 특화 프로젝트 3등)
...
<img src="/image/01_guide.gif" style="display: inline-block" height=323px />  

▲ 서비스를 소개하는 가이드 페이지  

### 초기 취향 파악 페이지
<img src="/image/02_character_select.png" style="display: inline-block" height=323px/>
<img src="/image/02_character_select.png" style="display: inline-block" height=323px />  

▲ 같이 맛 평가를 할 캐릭터 선택 페이지  

<img src="/image/03_initial_evaluations.png" style="display: inline-block" height=323px/>
<img src="/image/03_intial_evaluations.png" style="display: inline-block" height=323px />  

▲ 취향 파악을 위해 맛을 평가하는 페이지  

<img src="/image/04_inital_input.png" style="display: inline-block" height=323px/>
<img src="/image/04_initial_input.png" style="display: inline-block" height=323px />  

▲ 맛을 평가하는 화면   

<img src="/image/05_end_initial_evaluations.png" style="display: inline-block" height=323px/>
<img src="/image/05_end_initial_evaluations.png" style="display: inline-block" height=323px />  

▲ 5개의 음식을 평가하면 '맛 평가 종료하기' 버튼이 생긴다.  

### 메인 페이지
<img src="/image/06_main.gif" style="display: inline-block" />
<img src="/image/06_main.png" style="display: inline-block" height=323px />  

▲ 추천 받은 음식을 볼 수 있는 메인 페이지  

### 음식 페이지
<img src="/image/07_recipe.gif" style="display: inline-block" />
<img src="/image/07_recipe.gif" style="display: inline-block" height=323px />  

▲ 음식의 상세정보를 확인할 수 있는 음식 페이지  

### 햄버거 바
<img src="/image/08_hambuger_bar.png" style="display: inline-block" height=323px/>
<img src="/image/08_hambuger_bar.png" style="display: inline-block" height=323px />  

▲ 메뉴 이동을 위한 햄버거 바  

### 마이페이지
<img src="/image/09_mypage.png" style="display: inline-block" height=323px/>
<img src="/image/09_mypage.png" style="display: inline-block" height=323px />  

▲ 내가 선호하는 맛 정보와 즐겨찾기한 레시피를 볼 수 있는 마이 페이지  

<img src="/image/10_more.png" style="display: inline-block" height=323px/>
<img src="/image/10_more.png" style="display: inline-block" height=323px />  

▲ '더보기'버튼을 클릭해 즐겨찾기한 레시피 목록을 볼 수 있다.  

### 식단 일기 페이지
<img src="/image/11_diary.gif" style="display: inline-block" />
<img src="/image/11_diary.gif" style="display: inline-block" height=323px />  

▲ 먹은 음식과 그 날의 감정을 기록할 수 있는 식단 일기 페이지  

### 으른 입맛 테스트 페이지
<img src="/image/12_adult_taste.png" style="display: inline-block" height=323px/>
<img src="/image/12_adult_taste.png" style="display: inline-block" height=323px />  

▲ 입맛 연령 측정을 위한 설문 화면  

<img src="/image/13_adult_taste_result.png" style="display: inline-block" height=323px/>
<img src="/image/13_adult_taste_result.png" style="display: inline-block" height=323px />  

▲ 결과 화면  

<img src="/image/14_result_share.png" style="display: inline-block" height=323px/>  
...
## 시스템 아키텍처
![OMZ_System_Architecture](/image/OMZ_System_Architecture.png)
...
## 스케줄
![OMZ_Schedule](/image/OMZ_Schedule.PNG)
